...
export default function Home() {
  ...
  return (
    <main>
      <section style={{
        minHeight: '100vh',
        background: `linear-gradient(to bottom, rgba(26,16,8,0.6), rgba(26,16,8,0.85)),
        ...
        <h1 style={{ fontSize: 'clamp(3.5rem, 8vw, 7rem)', fontWeight: 300, lineHeight: 1.1, marginBottom: '1.5rem', color: 'var(--cream)', fontFamily: 'Cormorant Garamond' }}>
      ...
      <section style={{ background: 'var(--brown-mid)', padding: '6rem 2rem', textAlign: 'center' }}>
        <p style={{ color: 'var(--gold)', letterSpacing: '0.3em', fontSize: '0.7rem', textTransform: 'uppercase', marginBottom: '1.5rem' }}>Our Philosophy</p>
        <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3.5rem)', fontWeight: 300, maxWidth: '700px', margin: '0 auto 2rem', lineHeight: 1.3, fontFamily: 'Cormorant Garamond' }}>
        ...
        <p style={{ color: 'var(--text-light)', maxWidth: '560px', margin: '0 auto', lineHeight: 1.9, fontSize: '0.9rem' }}>
          ...
          crafting seasonal menus that tell the story of the land.
        </p>
      </section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem' }}>
          {[
            ...
            <div key={f.title} style={{ textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: '1.4rem', fontWeight: 400, color: 'var(--gold)', marginBottom: '1rem', fontFamily: 'Cormorant Garamond' }}>{f.title}</h3>
